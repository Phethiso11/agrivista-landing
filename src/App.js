...
import './App.css';
import writing from './icon.png';
import web from './Group.png';
import content from './Group (1).png'
import social from './Icon (1).png'
import insta from './Group 83.png'
import dribble from './Group 84.png'
import face from './Group 85.png'
import be from './Group 86.png'
    ...
    <div className="App">
      ...
      <section className="services-section">
        ...
        <div className="services">
          <div className="service">
            <i className="service-icon"><img src={writing} alt=''></img></i>
            <p>Blog and Article Writing</p>
          </div>
          <div className="service">
            <i className="service-icon"><img src={web} alt=''></img></i>
            <p>Website Content</p>
          </div>
          <div className="service">
            <i className="service-icon"><img src={content} alt=''></img></i>
            <p>Content Strategy and Consulting</p>
          </div>
          <div className="service">
            <i className="service-icon"><img src={social} alt=''></img></i>
      ...
      <section className="sustainability-section">
        ...
        <div className="sustainability-content hero-buttons">
          <button className="btn learn-more">Contact Us</button>
      ...
      <div className="benefit">
            <i className="benefit-icon"><img src={rate} alt=''></img></i>
            <i className="benefit-icon"><img src={pro} alt=''></img></i>
            <i className="benefit-icon"><img src={sat} alt=''></img></i>

            <i className="benefit-icon"><img src={loc} alt=''></img></i>
      ...
      <section className="testimonials-section">
        <div className="testimonial">
          ...
          <div className="testimonial-content">
            ...
            <p className="testimonial-p">Forward Creative Manager</p>
            <p>
        ...
        <div className="footer-container">
          <div className="footer-section">
            ...
            <div className="footer-icons">
              <a href="#i"><i className="icon-instagram"><img src={insta} alt=''></img></i></a>
              <a href="#i"><i className="icon-dribbble"><img src={dribble} alt=''></img></i></a>
              <a href="#i"><i className="icon-facebook"><img src={face} alt=''></img></i></a>
              <a href="#i"><i className="icon-behance"><img src={be} alt=''></img></i></a>
            </div>
          </div>
          <div className="footer-section">
            <h3>Pages</h3>
