        ...
        <div className="footer-container">
          <div className="footer-section">
            ...
            <div className="footer-icons">
              <a href="#i"><i className="icon-instagram"><img src='https://cdn-icons-png.flaticon.com/128/3991/3991634.png' alt=''></img></i></a>
              <a href="#i"><i className="icon-dribbble"><img src='https://cdn-icons-png.flaticon.com/128/3488/3488315.png' alt=''></img></i></a>
              <a href="#i"><i className="icon-facebook"><img src='https://cdn-icons-png.flaticon.com/128/1051/1051309.png' alt=''></img></i></a>
              <a href="#i"><i className="icon-behance"><img src='https://cdn-icons-png.flaticon.com/128/2111/2111325.png' alt=''></img></i></a>
            </div>
          </div>
          <div className="footer-section">
            <h3>Pages</h3>
